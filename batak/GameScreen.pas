...
begin
        //baþlangýctaki kaçta biter e ulaþýnca oyun biter

        if (form1.biterTxt.text=toplamA.text) or (form1.biterTxt.text=toplamB.text) then
            begin
              timer1.Enabled:=false;
              ShowMessage('Oyun Bitti Sonuçlar Geliyor...');
      ...
      if topA<topB then
      begin
         label3.Text:=edit3.Text+' Kaybediyorsunuz bir þeyler yapma vakti geldii!!';
      end
      else
      begin
          label3.Text:=edit4.Text+' Bu oyunu anca Çiz kurtarýr!!';
      end;
        timer2.Enabled:=true;
        ...
        floatanimation1.Enabled:=true;
         ...
         //Her 1 saniyede kim ondeyse kaybedeni kýrmýzýya boyar
    if topA>topB then
begin
